defmodule Zookeeper.Client do
  ...
  @type create_error ::
          ...
          | :closed
  @type create_options :: [create_mode: create_mode, acl: [acl], makepath: boolean]
  ...
  """
  @spec create(pid, String.t(), binary, create_options) ::
          {:ok, String.t()} | {:error, create_error}
  ...
  """
  @spec ensure_path(pid, String.t(), [acl] | nil) ::
          :ok | {:error, :no_auth | :invalid_acl | :no_children_for_ephemerals | :closed}
  ...
  @spec get(pid, String.t(), pid | nil) ::
          {:ok, {binary, %ZnodeStat{}}} | {:error, :no_node | :no_auth | :closed}
  ...
  """
  @spec get_children(pid, String.t(), pid | nil) ::
          {:ok, [String.t()]} | {:error, :no_node | :no_auth | :closed}
  ...
  """
  @spec get_acls(pid, String.t()) ::
          {:ok, {[acl], %ZnodeStat{}}} | {:error, :no_node | :no_auth | :closed}
  ...
  """
  @spec set_acls(pid, String.t(), [acl], integer) ::
          {:ok, %ZnodeStat{}}
          | {:error, :no_node | :bad_version | :no_auth | :closed | :invalid_acl}
  ...
  """
  @spec set(pid, String.t(), binary, integer) ::
          {:ok, %ZnodeStat{}} | {:error, :no_node | :bad_version | :no_auth | :closed}
  ...
  Delete a node.
  """
  @spec delete(pid, String.t(), integer, boolean) ::
          :ok | {:error, :no_node | :bad_version | :no_auth | :closed | :not_empty}
  ...
  def delete!(pid, path, version \\ -1, recursive \\ false),
    do: apply!(&delete/4, [pid, path, version, recursive])
  ...
  defp normalize_path(path) when is_bitstring(path),
    do: path |> String.to_char_list() |> normalize_path
